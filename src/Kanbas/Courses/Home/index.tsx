...
import { FaBan, FaCheckCircle, FaPlusCircle, FaRegCheckCircle, FaPlus, FaTimes, FaFileImport, FaCreativeCommons, FaCreativeCommonsSa, FaBullseye, FaBullhorn, FaBell, FaCalendar, FaRegCalendar, FaCalendarAlt } from "react-icons/fa";
        ...
        <>
            <div style={{ display: 'flex' }}>
                ...
                <div className="col-md-4 flex-grow-0 me-2 d-none d-lg-block" style={{ paddingLeft: '10px', width: '250px' }}>
                    ...
                    <button style={{ backgroundColor: 'lightgray', color: 'black', borderColor: 'gray' }} type="button" className="btn btn-primary-1"><FaBan /> Unpublish</button>
                    <button style={{ backgroundColor: 'green', color:'white', borderColor: 'gray'  }} type="button" className="btn btn-secondary-2" disabled><FaCircleCheck /> Published</button>
                    <br /><br />
